        ...
        <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] relative overflow-hidden font-[Inter]">
            ...
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] p-8 rounded-[8px] shadow-2xl w-full max-w-md z-10 fade-in-up">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-[22px] font-bold text-white tracking-tight">¡Te damos la bienvenida!</h2>
                    <p className="text-[12px] text-[#555] mt-1">Inicia sesión para acceder a tu panel de Lexis</p>
                </div>
                ...
                <div className="mt-6 text-center">
                    <p className="text-[#555] text-[12px]">
                        ...
                        <Link href="/register" className="text-green-400 hover:text-green-300 font-medium transition-colors ml-0.5">
                            Regístrate
                        </Link>
                    </p>
                </div>
