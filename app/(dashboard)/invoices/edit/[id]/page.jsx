...
export default function InvoiceEdit({ params }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) { const err = await res.json(); throw new Error(err.error || 'Error al guardar la factura'); }
    ...
    return (
        <div className="p-5 lg:p-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-[20px] font-bold text-white leading-tight">Editar Factura</h1>
                    <p className="text-[12px] text-[#555] mt-0.5">Actualiza los detalles y conceptos de la factura existente</p>
                </div>
            </div>
                ...
                <div className="flex justify-end gap-3 pt-2">
                    ...
                    <button type="submit" disabled={saving}
                        ...
                        {saving ? (
                            ...
                            <><Save size={14} /> Actualizar Factura</>
                        )}
                    </button>
                </div>
            </form>
